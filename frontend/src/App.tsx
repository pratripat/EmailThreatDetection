    ...
    try {
      ...
      if (source === 'backend' && report?.raw) {
        ...
        return {
          ...
          suspiciousReasons: Array.isArray(raw.suspiciousReasons) ? raw.suspiciousReasons : fallback.suspiciousReasons,
          headerHops: Array.isArray(raw.headerHops) ? raw.headerHops : fallback.headerHops,
          authentication: raw.authentication ? raw.authentication : fallback.authentication,
          urls: Array.isArray(raw.urls) ? raw.urls : fallback.urls,
          contentAi: raw.contentAi ? raw.contentAi : fallback.contentAi,
          iocs: raw.iocs ? raw.iocs : fallback.iocs,
          attackGraph: raw.attackGraph ? raw.attackGraph : fallback.attackGraph,
